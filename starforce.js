...
starforces.slice().reverse().forEach((starforce) => {
    ...
    row += "<td>" + (starforce.fail_observed / starforce.count).toFixed(2) + "% , " + starforce.fail_observed + "회" + "</td>"

    row += "<td>" + starforce.destory_rate.toFixed(2) + "% , " + (starforce.count * starforce.destory_rate / 100).toFixed(2) + "회" + "</td>"
    row += "<td>" + (starforce.destory_observed / starforce.count).toFixed(2) + "% , " + starforce.destory_observed + "회" + "</td>"
